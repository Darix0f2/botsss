...
module.exports = {
    ...
    run: async (client, message, args, prefix) => {
        ...
        if (args[0]) {
            ...
            .setColor(client.color)
            .setDescription(`Bot Multifuncional en desarrollo por \`Darix0f2\``)
